...
namespace payzen_backend.Controllers.SystemData
{
    ...
    public class WorkingCalendarsController : ControllerBase
    {
        ...
        /// <summary>
        /// Récupère un calendrier de travail par ID
        /// </summary>
        [HttpGet("{id}")]
        ...
        public async Task<ActionResult<WorkingCalendarReadDto>> GetById(int id)
        {
            ...
            if (calendar == null)
                return NotFound(new { Message = "Calendrier de travail non trouvé" });
        ...
        /// <summary>
        /// Récupère le calendrier de travail d'une société
        /// </summary>
        ...
        /// <summary>
        /// Crée un nouveau calendrier de travail
        /// </summary>
        [HttpPost]
        ...
        public async Task<ActionResult<WorkingCalendarReadDto>> Create([FromBody] WorkingCalendarCreateDto dto)
        {
            ...
            // Vérifier qu'un calendrier pour ce jour n'existe pas déjà pour cette société
            ...
            if (calendarExists)
                return Conflict(new { Message = "Un calendrier existe déjà pour ce jour de la semaine dans cette société" });

            // Validation des horaires si c'est un jour travaillé
            if (dto.IsWorkingDay)
            {
                if (dto.StartTime == null || dto.EndTime == null)
                    return BadRequest(new { Message = "Les horaires de début et de fin sont requis pour un jour travaillé" });

                if (dto.StartTime >= dto.EndTime)
                    return BadRequest(new { Message = "L'heure de début doit être avant l'heure de fin" });
            }
        ...
        /// <summary>
        /// Met à jour un calendrier de travail
        /// </summary>
        [HttpPut("{id}")]
        ...
        public async Task<ActionResult<WorkingCalendarReadDto>> Update(int id, [FromBody] WorkingCalendarUpdateDto dto)
        {
            ...
            if (dto.IsWorkingDay.HasValue)
            {
                ...
                // Si c'est un jour travaillé, vérifier les horaires
        ...
        /// <summary>
        /// Méthode helper pour obtenir le nom du jour de la semaine
        /// </summary>
