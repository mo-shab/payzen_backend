...
namespace payzen_backend.Controllers.Company
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        public async Task<ActionResult<CompanyReadDto>> PatchCompany(int id, [FromBody] CompanyUpdateDto dto)
        {
            ...
            // Logs pour debug (values reçues côté API)
            Console.WriteLine("====================");
            Console.WriteLine($"DTO raw: {JsonSerializer.Serialize(dto)}");
            Console.WriteLine($"ModelState.IsValid: {ModelState.IsValid}");
            Console.WriteLine($"Email reçu : '{dto.email ?? "null"}'");
            Console.WriteLine($"Phone reçu : '{dto.phoneNumber ?? "null"}'");
            ...
            // Log état courant de l'entreprise avant modification
