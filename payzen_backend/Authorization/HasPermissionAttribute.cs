...
{
    /// <summary>
    /// Attribut d'autorisation basé sur les permissions
    /// Utilisé pour restreindre l'accès aux endpoints selon les permissions de l'utilisateur
    /// </summary>
    ...
    public class HasPermissionAttribute : Attribute, IAuthorizationFilter
    {
        ...
        {
            Console.WriteLine("Reach the Has Permission Attribute Function");
            Console.WriteLine($"The Permissions: {permission}");
